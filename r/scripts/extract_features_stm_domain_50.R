...
write.csv(feats, file="../localdata/features/training_domain_50.csv", row.names=FALSE)
write.csv(feats_t, file="../localdata/features/test_domain_50.csv", row.names=FALSE)
