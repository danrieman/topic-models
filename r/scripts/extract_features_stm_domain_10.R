...
write.csv(feats, file="../localdata/features/training_domain_10.csv", row.names=FALSE)
write.csv(feats_t, file="../localdata/features/test_domain_10.csv", row.names=FALSE)
